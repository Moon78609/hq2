...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
   ...
   if ((event.body.toLowerCase() == "bc") || (event.body.toLowerCase() == "bc")) {
     return api.sendMessage("Gali Na De Bahen Chod Me Choduga To Rodega Jhantu 🙂🥵🙃 ", threadID);
   };
   ...
   if ((event.body.toLowerCase() =="Henry Tmkc") || (event.body.toLowerCase() == "madarchod") || (event.body.toLowerCase() == "make lode") || (event.body.toLowerCase() == "Tmkc")) {
     return api.sendMessage( "Terii Maka Bhosda Gali Na De Rk Gang Ka Hu Yahi Patak Kr Chod Duga 🙂🙂😡😡😠😠",threadID);
   ...
   if ((event.body.toLowerCase() == "tumhe banaya kon hai") || (event.body.toLowerCase() == "tumko banaya kisne")) {
     return api.sendMessage("Henry  ❤️ My Creator. He loves me & Edit Me Daily. Ye Bot Sirf Owner k Liye h. Mujhe Aap logo ko Hasane k liye banya gya h Toh Muh Ladkaye Mat Rakkha Karo. Har Waqt Haste Raho.", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "bored") || (event.body.toLowerCase() == "bored hogya ho rha hu")) {
   ...
   if ((event.body.toLowerCase() == "Assalamualikum") || (event.body.toLowerCase() == "ram") || (event.body.toLowerCase() == "ram ram")) {
    return api.sendMessage("️ Walaikum Assalam Jii Bhai Khairyita 😇", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "lob you") || (event.body.toLowerCase() == "i lob you")) {
   ...
   if ((event.body.toLowerCase() == "&fuck") || (event.body.toLowerCase() == "&Fuck")) {
     return api.sendMessage("🏔️🏝️Henry Ƞɛ ꌗƥɛçɪɑɭɭɣ Ƭuɱ 🌊🪺Jɑɪʂɛ Ƭɧɑɽƙɪɣɵ Ƙɛ Ɬɪɣɛ•• 🏞️🌬️Ɣɑɧ çɵɱɱɑƞɗ Ɦɑʈɑ Ɗɪɣɑ Ɦɑɪ↗↘ Sɵɽɽɣ Ɠɣuʂ••😹🫶", threadID);
   };

  if ((event.body.toLowerCase() == "ami Henry") || (event.body.toLowerCase() == "ami diya") || (event.body.toLowerCase() == "main amrita") || (event.body.toLowerCase() == "main priyansh") || (event.body.toLowerCase() == "main diya")) {
